...
function Game() {
    ...
    return (
        <div className={s.body}>
            <div className={s.background} style={{backgroundImage: `url(${SERVER_URL}/app/wwwroot/${state.backgroundImageUrl})`}}></div>
            {(!state.currentLocation?.isCutscene) && (
                <div className={s.hud}>
                    <div className={s.player}>
                        <div className={s.status}>
                            <img src={`${SERVER_URL}/app/wwwroot/${state.statusImageUrl}`} alt="Player status" />
                        </div>
                    ...
                    <div className={s.inventory}>
                        <button className={s.item} onClick={smokeCigarette}>
                            ...
                            <img className={s.itemImage} src={`${SERVER_URL}/app/wwwroot/inventory/cigarette.png`} alt="Cigarette" />
                        </button>
                        <div className={s.item}>
                            <p className={s.itemLabel}>
                                {(state.gameState.candlesTaken.match(/1/g) || []).length}
                            </p>
                            <img className={s.itemImage} src={`${SERVER_URL}/app/wwwroot/inventory/candle.png`} alt="Candle" />
                        </div>
                        <div className={s.item}>
                            <p className={s.itemLabel}>
                                {(state.gameState.pagesTaken.match(/1/g) || []).length}
                            </p>
                            <img className={s.itemImage} src={`${SERVER_URL}/app/wwwroot/inventory/page.png`} alt="Page" />
                        </div>
                    </div>
                </div>
            )}
